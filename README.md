...
> A production-ready, full-stack task management application with real-time collaboration features built with modern technologies and enterprise-level architecture.

[![Live Demo](https://img.shields.io/badge/demo-live-success?style=for-the-badge)](https://collaborative-task-manager-frontend.onrender.com)
[![Backend API](https://img.shields.io/badge/API-live-blue?style=for-the-badge)](https://collaborative-task-manager-backend-0glw.onrender.com)
...
- **Frontend:** [https://collaborative-task-manager-frontend.onrender.com](https://collaborative-task-manager-frontend.onrender.com)
- **Backend API:** [https://collaborative-task-manager-backend-0glw.onrender.com](https://collaborative-task-manager-backend-0glw.onrender.com)
- **API Health Check:** [https://collaborative-task-manager-backend-0glw.onrender.com/health](https://collaborative-task-manager-backend-0glw.onrender.com/health)
